...
<head>
    ...
    <title>Online Library Management System | Add DOCUMENT</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Add DOCUMENT</h4>
...
<body>
    ...
    <input type="text" name="names" placeholder="Enter name">
        ...
        <input type="text" name="address" placeholder="Enter description"/>
